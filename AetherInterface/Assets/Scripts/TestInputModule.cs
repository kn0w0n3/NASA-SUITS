...
{
    [AddComponentMenu("Event/Test Input Module")]
...
private bool AllowMoveEventProcessing(float time) {
    ...
    private bool SendMoveEventToSelectedObject() {
        ...
        private void GestureHandler_Tapped(UnityEngine.XR.WSA.Input.InteractionSourceKind source, int tapCount, Ray headRay)
        {
            m_Tapped = true;
            m_TapProcessed = false;
        }

        private void GestureHandler_NavigationStarted(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 normalizedOffset, Ray headRay) {
        ...
        private void GestureHandler_NavigationCompletedOrCanceled(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 normalizedOffset, Ray headRay) {
